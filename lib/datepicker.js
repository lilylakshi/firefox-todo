window.onload = function() {
  ...
  document.querySelectorAll(".datepicker").forEach(function(input) {
  	...
  	var dp = document.getElementById("contextmenu");
    var now = new Date();

    document.getElementsByClassName('month')[0].textContent = String(now.getMonth() + 1).padStart(2, "0");
    document.getElementsByClassName('year')[0].textContent = now.getFullYear();
